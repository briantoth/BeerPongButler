...
int main(int argc, char **argv){
  ...
  goalA.motion_plan_request.goal_constraints.position_constraints[0].position.x = 0.00;
  goalA.motion_plan_request.goal_constraints.position_constraints[0].position.y = -0.9;
  goalA.motion_plan_request.goal_constraints.position_constraints[0].position.z = 0.6;
  ...
  goalA.motion_plan_request.goal_constraints.orientation_constraints[0].orientation.y = 1.0;
