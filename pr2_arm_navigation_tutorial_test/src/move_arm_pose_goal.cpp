...
int main(int argc, char **argv){
  ...
  goalA.motion_plan_request.goal_constraints.position_constraints[0].position.x = 0.7;
  goalA.motion_plan_request.goal_constraints.position_constraints[0].position.y = 0;
  goalA.motion_plan_request.goal_constraints.position_constraints[0].position.z = 0.90;
