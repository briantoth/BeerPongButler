...
int main(int argc, char **argv){
  ...
  goalB.motion_plan_request.allowed_planning_time = ros::Duration(30.0);
  ...
  goalB.motion_plan_request.goal_constraints.joint_constraints[0].position = 0.251481481481;
  goalB.motion_plan_request.goal_constraints.joint_constraints[1].position = -0.52;
  goalB.motion_plan_request.goal_constraints.joint_constraints[2].position = -3.20962962963;
  goalB.motion_plan_request.goal_constraints.joint_constraints[3].position = 0.345185185185;
