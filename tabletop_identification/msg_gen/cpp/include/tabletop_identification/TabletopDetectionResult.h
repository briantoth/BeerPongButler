/* Auto-generated by genmsg_cpp for file /home/brian/fuerte_workspace/sandbox/tabletop_identification/msg/TabletopDetectionResult.msg */
#ifndef TABLETOP_IDENTIFICATION_MESSAGE_TABLETOPDETECTIONRESULT_H
#define TABLETOP_IDENTIFICATION_MESSAGE_TABLETOPDETECTIONRESULT_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct TabletopDetectionResult_ {
  ...
  typedef boost::shared_ptr< ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct TabletopDetectionResult
typedef  ::tabletop_identification::TabletopDetectionResult_<std::allocator<void> > TabletopDetectionResult;

typedef boost::shared_ptr< ::tabletop_identification::TabletopDetectionResult> TabletopDetectionResultPtr;
typedef boost::shared_ptr< ::tabletop_identification::TabletopDetectionResult const> TabletopDetectionResultConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> > {
  static const char* value() 
  {
    return "026c0e5e13258b4a96f7d3999ea3cd64";
  }

  static const char* value(const  ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x026c0e5e13258b4aULL;
  static const uint64_t static_value2 = 0x96f7d3999ea3cd64ULL;
};

template<class ContainerAllocator>
struct DataType< ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> > {
  static const char* value() 
  {
    return "tabletop_identification/TabletopDetectionResult";
  }
...
template<class ContainerAllocator>
struct Definition< ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct Serializer< ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::tabletop_identification::TabletopDetectionResult_<ContainerAllocator> & v) 
  {
    s << indent << "table: ";
s << std::endl;
    Printer< ::tabletop_identification::Table_<ContainerAllocator> >::stream(s, indent + "  ", v.table);
...
#endif // TABLETOP_IDENTIFICATION_MESSAGE_TABLETOPDETECTIONRESULT_H
